...
import { ShoppingCart } from "lucide-react"; //searched cause i want to use an icon
    ...
    >
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-lg font-medium text-center w-[40px]">
            {quantity}
          </span>
      ...
      <div>
        ...
        <select
          ...
          required
          className="w-full appearance-none border border-gray-300 rounded px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
        >
